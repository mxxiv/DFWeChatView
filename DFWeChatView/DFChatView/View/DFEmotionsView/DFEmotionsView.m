...
-(void) initEmotionTabs
{
    ...
    for (int i = 0; i<_emotions.count + 2; i++) {
        ...
        if (i == _emotions.count) {
            ...
            UIButton *btn = [self getEmotionTabButton:CGRectMake(x, y, width, height) icon:@"EmotionsSetting" iconImage:nil];
        ...
        if (i == _emotions.count+1) {
            ...
            UIButton *btn = [self getEmotionTabButton:CGRectMake(x, y, width, height) icon:@"EmotionsBagAdd" iconImage:nil];
            [_tabScrollView addSubview:btn];
            continue;
        }
        ...
        UIButton *btn = [self getEmotionTabButton:CGRectMake(x, y, width, height) icon:emotion.tabIcon iconImage:emotion.tabIconImage];
        [_tabScrollView addSubview:btn];
        btn.tag = i;
...
-(UIButton *) getEmotionTabButton:(CGRect) frame icon:(NSString *) icon iconImage:(UIImage *) iconImage
{
